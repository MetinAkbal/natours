...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWV0aW5hYSIsImEiOiJja2RyYTd0Z2MwNDNpMnlwa2dhdWd5eDk3In0.7kQHY8Pd4xMirNDvoHVMZg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/metinaa/ckdrae7uw0s9919n08cm0c0xj',
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var merkup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
var stripe = Stripe('pk_test_51HWQbXDs3AXkRbkaXYsKkYvRjFAWUc6ZPQrfCEU4PwVGdqztu1fU4mJmUZ91sqHoohPQrtsSpzyh6dhmCQYGCQ9Q00w6lxcmsZ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout from + chanrge credit card
